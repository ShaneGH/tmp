...
import { execute } from "../../ts-validator.code-gen/src/executor";
...
describe("Client side validator smoke tests", () =>
    testCases.forEach((val, i) => it("should not throw " + i, finished => {
        ...
        const typesFileLocation = "C:\\proj\\ts-validator.validator-types.ts";
        ...
        const dependencies = {
            ...
            convertToRelativePath: (pathFrom: string, pathTo: string) => {
                if (pathFrom === sourceFileName && pathTo === typesFileLocation) {
                ...
                // Error: Unknown convertToRelativePath: C:\proj\src\testFile.ts C:\proj\ts-validator.code-gen-types.ts
